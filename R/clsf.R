...
#' @return The original dataframe P augmented with an achor marker column
#' @importFrom magrittr %>%
#' @export
findAnchor <- function( P, cid, vm, pthr = 0.65 )
{
    ...
    P1 %>%
        ...
        dplyr::select( {{cid}}, Anchor, everything() )
}
